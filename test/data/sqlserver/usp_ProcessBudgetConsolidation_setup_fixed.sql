-- Test Data for usp_ProcessBudgetConsolidation (SQL Server) - FIXED
-- Matches actual SQL Server schema
...
-- BudgetHeader (1 row) - using correct columns
SET IDENTITY_INSERT Planning.BudgetHeader ON;

INSERT INTO Planning.BudgetHeader (BudgetHeaderID, BudgetCode, BudgetName, BudgetType, FiscalYear, VersionNumber, StatusCode, CreatedDateTime)
VALUES
(1, 'BUD-2024-001', '2024 Operating Budget', 'OPERATING', 2024, 1, 'APPROVED', GETDATE());

SET IDENTITY_INSERT Planning.BudgetHeader OFF;
GO

-- BudgetLineItem (20 rows) - using correct columns
INSERT INTO Planning.BudgetLineItem (BudgetHeaderID, GLAccountID, CostCenterID, FiscalPeriodID, OriginalAmount, AdjustedAmount, SpreadMethodCode)
VALUES
-- Corporate direct entries
(1, 1, 1, 1, 100000, 0, 'MANUAL'),
(1, 2, 1, 1, 45000, 0, 'MANUAL'),
-- Engineering entries
(1, 1, 2, 1, 80000, 0, 'MANUAL'),
(1, 3, 2, 1, 35000, 0, 'MANUAL'),
-- Sales entries
(1, 1, 3, 1, 150000, 0, 'MANUAL'),
(1, 3, 3, 1, 25000, 0, 'MANUAL'),
-- Marketing entries
(1, 1, 4, 1, 60000, 0, 'MANUAL'),
(1, 3, 4, 1, 40000, 0, 'MANUAL'),
-- Backend Team entries
(1, 1, 5, 1, 45000, 0, 'MANUAL'),
(1, 3, 5, 1, 20000, 0, 'MANUAL'),
-- Frontend Team entries
(1, 1, 6, 1, 38000, 0, 'MANUAL'),
(1, 3, 6, 1, 18000, 0, 'MANUAL'),
-- Sales West entries
(1, 1, 7, 1, 30000, 0, 'MANUAL'),
(1, 2, 7, 1, 18000, 0, 'MANUAL'),
-- Intercompany entries (matched pair: CORP <-> ENG)
(1, 6, 1, 1, 10000, 0, 'MANUAL'),
(1, 6, 2, 1, -10000, 0, 'MANUAL'),
-- Additional Q2 entries
(1, 1, 1, 2, 52000, 0, 'MANUAL'),
(1, 1, 2, 2, 82000, 0, 'MANUAL'),
(1, 1, 3, 2, 125000, 0, 'MANUAL'),
(1, 3, 1, 2, 28000, 0, 'MANUAL');
GO

SELECT 'SQL Server test data loaded' AS Status;
GO
