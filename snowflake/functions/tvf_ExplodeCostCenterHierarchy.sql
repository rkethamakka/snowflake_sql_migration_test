...
WITH RECURSIVE hierarchy AS (
    SELECT 
        ...
        1 as HierarchyLevel, CostCenterCode as HierarchyPath
    ...
    UNION ALL
    SELECT 
        c.CostCenterID, c.CostCenterCode, c.CostCenterName, c.ParentCostCenterID,
        h.HierarchyLevel + 1, h.HierarchyPath || '/' || c.CostCenterCode
