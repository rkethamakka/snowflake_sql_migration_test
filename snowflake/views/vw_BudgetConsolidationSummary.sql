...
GROUP BY bh.BudgetHeaderID, bh.BudgetCode, bh.BudgetName, bh.FiscalYear,
         cc.CostCenterCode, cc.CostCenterName, gla.AccountNumber, gla.AccountName, fp.PeriodName;
