...
/*
    ...
    FIXED VERSION: Removed buggy OUTPUT clause that caused arithmetic overflow
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            -- FIX: Removed buggy OUTPUT clause that inserted RemainingAmount (large $) 
            -- into AllocationPercentage (DECIMAL 8,6 max 99.999999) causing overflow.
            -- The real allocation INSERT happens below using vw_AllocationRuleTargets.
            UPDATE q
            SET 
                q.IsProcessed = 1,
